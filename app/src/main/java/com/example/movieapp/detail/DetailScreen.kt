...
import com.example.movieapp.component.MovieDetailsItem
import com.example.movieapp.component.TrailersDetailsItem
...
fun DetailRoute(
    ...
    DetailScreen (
        ...
        addToWishlist = viewModel::onWishlistMovie,
...
fun MovieContent(
    ...
    LazyColumn(
        ...
        item{
            MovieStoryLine(storyLine = movie?.overview?:"")
        }
        item{
            MovieCastAndCrew(credits = movie?.credits)
        }
        item{
...
fun MovieActions() {
    Row(verticalAlignment = Alignment.CenterVertically,
        ...
        Button(
            ...
            modifier = Modifier.size(115.dp,48.dp)
        ) {
            Icon(
        ...
        IconButton(
            ...
            Icon(painter = painterResource(id = R.drawable.ic_download),
                contentDescription = "Download", tint = Orange)
        }
        Spacer(modifier = Modifier.width(8.dp))
        IconButton(
